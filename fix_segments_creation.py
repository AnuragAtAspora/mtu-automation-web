#!/usr/bin/env python3
"""
Fix the segments creation issue by ensuring all 16 segments are created/reused properly
"""
...
def create_all_metrics_segments_fixed(start_date, end_date):
    """Create all 16 segments needed for metrics calculation with proper error handling"""
    
    print("🔧 FIXED: create_metrics_segments Function")
    print("=" * 60)
    ...
    if len(segments) < 16:
        print(f"⚠️  WARNING: Only {len(segments)} segments created/found instead of 16")
        print("This might be due to API timeouts or errors. Check the logs above.")
...
if __name__ == "__main__":
    result = create_all_metrics_segments_fixed("2026-01-01", "2026-01-31")
